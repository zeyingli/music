...
<head>
    <meta charset="UTF-8">
    <title>Music Search Tools - By Zeying</title>
    ...
    <link rel="canonical" href="https://music.zeyingli.com/">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">Music Search Tools</h2>
                <p class="am-text-center">https://musicbot.zeyingli.com</p>
            </header>
            <hr>
                ...
                <form id="j-validator" class="am-form am-margin-bottom-lg" method="post">
                    <div class="am-u-md-12 am-u-sm-centered">
                        ...
                        <div class="am-form-group">
                            <input id="j-input" data-filter="name" class="am-form-field am-input-lg am-text-center am-radius" placeholder="例如: 我想大声告诉你 樊凡" data-am-loading="{loadingText: ' '}" pattern="^.+$" required>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="https://www.zeyingli.com" target="_blank" rel="author">ZEYINGLI</p>
    </footer>
